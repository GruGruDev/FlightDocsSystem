    ...
    public partial class AddAllTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleClaimsTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoleClaimsTypes_DocTypes_TypeId",
                        column: x => x.TypeId,
                        principalTable: "DocTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoleClaimsTypes_Roles_AppRoleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleClaimsDocs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoleClaimsDocs_Docs_DocsId",
                        column: x => x.DocsId,
                        principalTable: "Docs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoleClaimsDocs_Roles_AppRoleId",
                        column: x => x.AppRoleId,
                        principalTable: "Roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleClaimsDocs_AppRoleId",
                table: "RoleClaimsDocs",
                column: "AppRoleId");

            migrationBuilder.CreateIndex(
                name: "IX_RoleClaimsDocs_DocsId",
                table: "RoleClaimsDocs",
                column: "DocsId");

            migrationBuilder.CreateIndex(
                name: "IX_RoleClaimsTypes_AppRoleId",
                table: "RoleClaimsTypes",
                column: "AppRoleId");

            migrationBuilder.CreateIndex(
                name: "IX_RoleClaimsTypes_TypeId",
                table: "RoleClaimsTypes",
                column: "TypeId");
